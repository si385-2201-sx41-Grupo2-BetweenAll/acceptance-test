Scenario 1: Como cliente que asiste a eventos quiero comprar entradas de un evento
...
Scenario 2: Como cliente que asiste a eventos quiero comprar entradas de un evento
...
Scenario 3: Como cliente que asiste a eventos quiero comprar entradas de un evento
...
Scenario 4: Como cliente que asiste a eventos quiero comprar entradas de un evento
...
And el cliente que asiste a eventos llene los datos necesarios para su compra
And la aplicación evalúa que los datos ingresados no fueron los correctos
Then al cliente que asiste a eventos se le mostrará una pantalla de “Error”.
