Scenario 1: Como cliente que asiste a eventos quiero que la aplicación tenga una interfaz sencilla para poder registrarme
...
Scenario 2: Como cliente que crea eventos quiero que la aplicación tenga una interfaz sencilla para poder registrarme
